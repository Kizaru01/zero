...
const page = () => {
  return (
    <main className='max-w-7xl px-5 mx-auto w-full pt-23.5 pb-18 min-h-screen'>
        <div className='mx-auto max-w-180 space-y-10 text-center'>
            <section className='flex flex-col gap-5'>
                ...
                <p className='text-xl text-(--text-secondary) leading-7'>Upload a PDF to generate your interactive reading</p>
            </section>
        </div>
        <UploadForm/>
    </main>
